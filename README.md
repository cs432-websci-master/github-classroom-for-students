...
This is a guide for students to setup Git and GitHub for use with GitHub Classroom. You may use RStudio in our class, so we will give instructions on how to use RStudio to setup Git locally. You may want to use [Github Desktop](https://desktop.github.com) instead of RStudio for managing your GitHub repo with a GUI.  If you are not familiar with the command-line, I would encourage you to use RStudio or GitHub Desktop to ensure that your updates are pushed back to GitHub. 
